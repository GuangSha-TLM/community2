...
import { activeUpdateBo, activityResponseData, imgUpDown, activityByIdResponseData, activeSelectByIdBo, addActivityResponseData, activeAdd, activeDeleteByIdBo, delectActivityResponseData } from '@/model/activityData'
...
//通过title来获取数据
export const activitySearchBytitle = (activitySearchBytitle: any) => {
    return request.post<any, any>('/activity/likeToGet', activitySearchBytitle)
}